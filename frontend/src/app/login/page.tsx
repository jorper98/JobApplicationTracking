      ...
      <div className="w-full max-w-sm">
        <div className="flex items-center justify-center gap-2.5 mb-6">
          ...
          <div className="flex flex-col leading-none">
            ...
            <span className="text-[10px] text-gray-400 dark:text-[#6b6b72] mt-0.5">v1.1.3</span>
          </div>
        </div>
        ...
        <div className="bg-white dark:bg-[#16161f] border border-gray-200 dark:border-white/[0.08] rounded-2xl p-6">
          ...
          <p className="text-sm text-gray-500 dark:text-[#8b8b96] mb-5">Enter your credentials to continue</p>
