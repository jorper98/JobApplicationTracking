            ...
            <div className="space-y-2 min-h-[100px]">
                ...
                >
                  <div className="flex items-start gap-1.5">
                    ...
                    <button
                      ...
                      className="text-gray-400 dark:text-[#5a5a64] hover:text-red-600 dark:text-red-400 transition-colors p-0.5 shrink-0 opacity-0 group-hover:opacity-100"
                      title="Remove"
                    >
              ...
              {(board[key] || []).length === 0 && (
                <div className="border-2 border-dashed border-gray-200 dark:border-white/[0.06] rounded-xl h-16 flex items-center justify-center">
                  <p className="text-xs text-gray-400 dark:text-[#5a5a64]">Drop here</p>
                </div>
              )}
            </div>
          </div>
